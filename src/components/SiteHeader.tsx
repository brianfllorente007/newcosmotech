    ...
    <header className="sticky top-0 z-40 border-b border-border/60 bg-background/85 backdrop-blur supports-[backdrop-filter]:bg-background/70">
      <Container className="flex h-16 items-center justify-between">
        ...
        <div className="hidden md:block">
          <Link
            to="/contact"
            className="inline-flex h-9 items-center rounded-full bg-brass px-4 text-sm font-semibold text-ink transition-transform hover:-translate-y-0.5"
          >
            Talk to our team
          </Link>
        </div>
        ...
        <div className="border-t border-border md:hidden">
          <Container className="flex flex-col gap-1 py-3">
            ...
            <Link
              to="/contact"
              onClick={() => setOpen(false)}
              className="mt-2 inline-flex h-10 items-center justify-center rounded-full bg-brass px-4 text-sm font-semibold text-ink"
            >
              Talk to our team
            </Link>
          </Container>
